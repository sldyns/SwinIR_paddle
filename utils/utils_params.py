...
#crt_net = paddle.load('../../experiments/debug_SRResNet_bicx4_in3nf64nb16/models/8_G.pth')
#
...
#paddle.save(crt_net, '../pretrained_tmp.pdparams')

# x2 -> x3
'''
in_filter = pretrained_net['model.2.weight'] # 256, 64, 3, 3
new_filter = paddle.Tensor(576, 64, 3, 3)
...
#    out_new_bias = paddle.Tensor(1).fill_(out_new_bias)
...
if __name__ == '__main__':
    ...
    net = paddle.vision.models.vgg19(pretrained=True)
