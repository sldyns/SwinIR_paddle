...
# ============================================
# SSIM loss
# https://github.com/Po-Hsun-Su/pypaddle-ssim
# ============================================
"""


def gaussian(window_size, sigma):
    gauss = paddle.Tensor([exp(-(x - window_size//2)**2/float(2*sigma**2)) for x in range(window_size)])
...
if __name__ == '__main__':
    ...
    img1 = paddle.Tensor(np.rollaxis(npImg1, 2)).float().unsqueeze(0)/255.0
    img2 = paddle.rand(img1.size())

    img1.stop_gradient=True
    img2.stop_gradient=False
