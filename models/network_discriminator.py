...
# --------------------------------------------
class Discriminator_PatchGAN(nn.Layer):
...
class Discriminator_UNet(nn.Layer):
...
# --------------------------------------------
class Discriminator_VGG_96(nn.Layer):
...
# --------------------------------------------
class Discriminator_VGG_192(nn.Layer):
    def __init__(self, in_nc=3, base_nc=64, ac_type='BL'):
...
# --------------------------------------------
class Discriminator_VGG_128_SN(nn.Layer):
    def __init__(self):
